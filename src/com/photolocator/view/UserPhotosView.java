...
public class UserPhotosView extends LinearLayout implements OnClickListener
{
	...
	private void init(Context context)
	{
		...
		mViewPager = (ScrollViewPager) mView.findViewById(R.id.userphoto_scrollviewpager);
	...
	private void initViewPager()
	{
		...
		{
		case 1:
			mPhotoPage1 = mInflater.inflate(R.layout.common_userphoto_avatar, null);
		...
		case 2:
			mPhotoPage1 = mInflater.inflate(R.layout.common_userphoto_avatar, null);
			mPhotoPage2 = mInflater.inflate(R.layout.common_userphoto_avatar, null);
			initPhotoBlocks(mPhotoPage1, 1);
		...
		case 3:
			mPhotoPage1 = mInflater.inflate(R.layout.common_userphoto_avatar, null);
			mPhotoPage2 = mInflater.inflate(R.layout.common_userphoto_avatar, null);
			mPhotoPage3 = mInflater.inflate(R.layout.common_userphoto_avatar, null);
			initPhotoBlocks(mPhotoPage1, 1);
			initPhotoBlocks(mPhotoPage2, 2);
	...
	private void initPhotoBlocks(View view, int page)
	{
		...
		mPhotoBlocks[0] = view.findViewById(R.id.userphoto_avatar_layout_photo_block1);
		mPhotoBlocks[1] = view.findViewById(R.id.userphoto_avatar_layout_photo_block2);
		mPhotoBlocks[2] = view.findViewById(R.id.userphoto_avatar_layout_photo_block3);
		mPhotoBlocks[3] = view.findViewById(R.id.userphoto_avatar_layout_photo_block4);
		mPhotoBlocks[4] = view.findViewById(R.id.userphoto_avatar_layout_photo_block5);
		mPhotoBlocks[5] = view.findViewById(R.id.userphoto_avatar_layout_photo_block6);
		mPhotoBlocks[6] = view.findViewById(R.id.userphoto_avatar_layout_photo_block7);
		mPhotoBlocks[7] = view.findViewById(R.id.userphoto_avatar_layout_photo_block8);
		...
		for (int i = startPosition; i < endPosition; i++)
		{
			...
			RoundImageView photo = (RoundImageView) root.findViewById(R.id.userphoto_avatar_item_riv_avatar);
			photo.setImageBitmap(mApplication.getPhotoThumbnail(mPhotos.get(i)));
			ImageView cover = (ImageView) root.findViewById(R.id.userphoto_avatar_item_iv_cover);
			cover.setTag(i);
	...
	{
		int margin = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, value, getResources()
				.getDisplayMetrics());
		return margin;
	}
