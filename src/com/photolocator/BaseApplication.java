...
/*import com.baidu.location.BDLocation;
 ...
 import com.photolocator.entity.NearByGroup;
...
public class BaseApplication extends Application
{
	...
	public void onCreate()
	{
		 ...
		 * mLocationClient.setAK("60b43d1a9513d904b6aa2948b27b4a20"); mLocationClient.registerLocationListener(new
		 * BDLocationListener()
		 */
		/*
		 * {
		 ...
		 * }
		 * 
		 * @Override public void onReceiveLocation(BDLocation arg0) { mLongitude = arg0.getLongitude(); mLatitude =
		 * arg0.getLatitude(); Log.i("地理位置", "经度:" + mLongitude + ",纬度:" + mLatitude); mLocationClient.stop(); } });
		 */
		/*
		 * mLocationClient.start(); mLocationClient.requestOfflineLocation();
		 */
