package com.photolocator.entity;
...
public class NearByPeople extends Entity implements Parcelable
{
	...
	public NearByPeople(String uid, String avatar, int isVip, int isGroupRole, String industry, int isbindWeibo,
			int isbindTxWeibo, int isbindRenRen, int device, int isRelation, int isMultipic, String name, int gender,
			int age, String distance, String time, String sign)
	{
		super();
		this.uid = uid;
		this.avatar = avatar;
		...
		this.sign = sign;
		/*
		 * if (gender == 0) { setGenderId(R.drawable.ic_user_famale); setGenderBgId(R.drawable.bg_gender_famal); } else
		 * { setGenderId(R.drawable.ic_user_male); setGenderBgId(R.drawable.bg_gender_male); }
		 */
	}
	...
	public static final Parcelable.Creator<NearByPeople> CREATOR = new Parcelable.Creator<NearByPeople>()
	{
		...
		public NearByPeople createFromParcel(Parcel source)
		{
			...
			NearByPeople people = new NearByPeople(uid, avatar, isVip, isGroupRole, industry, isbindWeibo,
					isbindTxWeibo, isbindRenRen, device, isRelation, isMultipic, name, gender, age, distance, time,
					sign);
			return people;
		}
