...
import com.photolocator.view.RoundImageView;
import com.photolocator.view.UserPhotosView;
import com.photolocator.view.UserPhotosView.onPagerPhotoItemClickListener;

public class OtherProfileActivity extends BaseActivity implements OnClickListener, onPagerPhotoItemClickListener
{
	...
	public void onClick(View v)
	{
		...
		case R.id.otherprofile_layout_feed:
			intent = new Intent(OtherProfileActivity.this, OtherFeedListActivity.class);
	...
	{
		Intent intent = new Intent(OtherProfileActivity.this, ImageBrowserActivity.class);
		...
		if (mProfile == null)
		{
			putAsyncTask(new AsyncTask<Void, Void, Boolean>()
			{
				...
				protected Boolean doInBackground(Void... params)
				{
					...
					return JsonResolveUtils.resolveNearbyProfile(OtherProfileActivity.this, mProfile, mUid);
				}
	...
	private void initProfile()
	{
		...
		if (mProfile.isHasSign())
		{
			...
			if (mProfile.getSignPicture() != null)
			{
				...
				mRivFeedPicture.setImageBitmap(mApplication.getStatusPhoto(mProfile.getSignPicture()), 5);
			}
			else
			{
	...
	{
		/*
		 * View group = LayoutInflater.from(OtherProfileActivity.this).inflate(R.layout.otherprofile_joingroup_item,
		 * null); mLayoutJoinGroup.addView(group); ImageView mIvAvatar = (ImageView)
		 * group.findViewById(R.id.joingroup_item_avatar); EmoticonsTextView mEtvName = (EmoticonsTextView)
		 * group.findViewById(R.id.joingroup_item_name); HandyTextView mHtvOwner = (HandyTextView)
		 * group.findViewById(R.id.joingroup_item_owner);
		 */
		/*
		 * mIvAvatar.setImageBitmap(mApplication.getAvatar("nearby_group_1")); mEtvName.setText("℡一群二B的小青年");
