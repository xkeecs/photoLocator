...
import com.photolocator.adapter.ImageBrowserAdapter;
import com.photolocator.entity.NearByPeopleProfile;
import com.photolocator.view.PhotoTextView;
import com.photolocator.view.ScrollViewPager;

public class ImageBrowserActivity extends BaseActivity implements OnPageChangeListener, OnClickListener
{
	...
	private void init()
	{
		...
		if (TYPE_ALBUM.equals(mType))
		{
			...
			if (mTotal > 1)
			{
				...
				mAdapter = new ImageBrowserAdapter(mApplication, mProfile.getPhotos(), mType);
