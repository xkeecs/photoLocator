...
public abstract class BaseActivity extends FragmentActivity
{
	...
	/*
	 * protected NetWorkUtils mNetWorkUtils; protected FlippingLoadingDialog mLoadingDialog;
	 */
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		/*
		 * mNetWorkUtils = new NetWorkUtils(this); mLoadingDialog = new FlippingLoadingDialog(this, "请求提交中");
		 */
	...
	protected void showCustomToast(int resId)
	{
		 ...
		 * ((HandyTextView) toastRoot.findViewById(R.id.toast_text)).setText(getString(resId)); Toast toast = new
		 * Toast(BaseActivity.this); toast.setGravity(Gravity.CENTER, 0, 0); toast.setDuration(Toast.LENGTH_SHORT);
	...
	protected void showCustomToast(String text)
	{
		/*
		 * View toastRoot = LayoutInflater.from(BaseActivity.this).inflate(R.layout.common_toast, null);
		 * ((HandyTextView) toastRoot.findViewById(R.id.toast_text)).setText(text); Toast toast = new
		 * Toast(BaseActivity.this); toast.setGravity(Gravity.CENTER, 0, 0); toast.setDuration(Toast.LENGTH_SHORT);
		 * toast.setView(toastRoot); toast.show();
		 */
	}
