...
import com.photolocator.BasePopupWindow;
import com.photolocator.R;
import com.photolocator.view.HandyTextView;

public class OtherFeedListPopupWindow extends BasePopupWindow implements OnClickListener
{
	...
	{
		super(LayoutInflater.from(context).inflate(R.layout.include_dialog_otherfeedlist, null), width, height);
	...
	public void setOnOtherFeedListPopupItemClickListner(onOtherFeedListPopupItemClickListner l)
	{
