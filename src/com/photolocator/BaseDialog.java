...
/*		mBtnButton1.setOnClickListener(this);
	...
	{
		/*
		 * switch (v.getId()) { case R.id.dialog_generic_btn_button1: if (mOnClickListener1 != null) {
		 * mOnClickListener1.onClick(mBaseDialog, 0); } break;
		 * 
		 * case R.id.dialog_generic_btn_button2: if (mOnClickListener2 != null) { mOnClickListener2.onClick(mBaseDialog,
		 * 1); } break;
		 * 
		 * case R.id.dialog_generic_btn_button3: if (mOnClickListener3 != null) { mOnClickListener3.onClick(mBaseDialog,
		 * 2); } break; }
		 */
	}
}
