...
import com.photolocator.activity.ImageBrowserActivity;
import com.photolocator.view.photoview.PhotoView;
...
public class ImageBrowserAdapter extends PagerAdapter
{
	...
	public View instantiateItem(ViewGroup container, int position)
	{
		...
		{
			bitmap = mApplication.getPhotoOriginal(mPhotos.get(position % mPhotos.size()));
		}
