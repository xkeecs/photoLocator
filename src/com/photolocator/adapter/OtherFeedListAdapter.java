package com.photolocator.adapter;
...
import com.photolocator.activity.FeedProfileActivity;
import com.photolocator.dialog.FlippingLoadingDialog;
...
public class OtherFeedListAdapter extends BaseObjectListAdapter implements onSimpleListItemClickListener,
		onOtherFeedListPopupItemClickListner
{
	...
	public OtherFeedListAdapter(NearByPeopleProfile profile, NearByPeople people, BaseApplication application,
			Context context, List<? extends Entity> datas)
	{
		super(application, context, datas);
		mProfile = profile;
		mPeople = people;
		mWidthAndHeight = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 120, context.getResources()
				.getDisplayMetrics());
	...
	public View getView(final int position, View convertView, ViewGroup parent)
	{
		...
		holder.avatar.setImageBitmap(mApplication.getAvatar(mProfile.getAvatar()));
		...
		holder.more.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View arg0)
			{
				...
				mPopupWindow.showAtLocation(arg0, Gravity.NO_GRAVITY, location[0], location[1] - mWidthAndHeight + 30);
			}
		});
	...
	{
		final FlippingLoadingDialog dialog = new FlippingLoadingDialog(mContext, "正在提交,请稍后...");
		dialog.show();
