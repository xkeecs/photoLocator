...
public class NearByPeopleAdapter extends BaseObjectListAdapter
{
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		if (convertView == null)
		{
			...
			holder.mIvWeibo = (ImageView) convertView.findViewById(R.id.user_item_iv_icon_weibo);
			holder.mIvTxWeibo = (ImageView) convertView.findViewById(R.id.user_item_iv_icon_txweibo);
			holder.mIvRenRen = (ImageView) convertView.findViewById(R.id.user_item_iv_icon_renren);
			holder.mIvDevice = (ImageView) convertView.findViewById(R.id.user_item_iv_icon_device);
			holder.mIvRelation = (ImageView) convertView.findViewById(R.id.user_item_iv_icon_relation);
			holder.mIvMultipic = (ImageView) convertView.findViewById(R.id.user_item_iv_icon_multipic);
		...
		holder.mIvAvatar.setImageBitmap(mApplication.getAvatar(people.getAvatar()));
		...
		if (people.getIsGroupRole() != 0)
		{
			...
			{
				holder.mIvGroupRole.setImageResource(R.drawable.ic_userinfo_groupowner);
			}
		}
		else
		{
		...
		if (!android.text.TextUtils.isEmpty(people.getIndustry()))
		{
			...
			holder.mIvIndustry.setImageBitmap(PhotoUtils.getIndustry(mContext, people.getIndustry()));
		}
		else
		{
			holder.mIvIndustry.setVisibility(View.GONE);
		...
		if (people.getIsbindTxWeibo() != 0)
		{
			...
			{
				holder.mIvTxWeibo.setImageResource(R.drawable.ic_userinfo_tweibov);
			}
		}
		else
		{
