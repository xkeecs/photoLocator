...
public class ImageFactoryFliter extends ImageFactory
{
	...
	public ImageFactoryFliter(ImageFactoryActivity activity, View contentRootView)
	{
	...
	{
		mSelectBitmap = PhotoUtils.getFilter(mFilterItems.get(mSelectBlock).mFilterType, mBitmap);
